...
class OperationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'commission_payer' => $this->commission_payer?->value,
            'commission_amount' => $this->commission_amount,
            'customer_commission_amount' => $this->customer_commission_amount,
            'supplier_commission_amount' => $this->supplier_commission_amount,
