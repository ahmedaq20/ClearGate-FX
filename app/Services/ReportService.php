...
class ReportService
{
    ...
    private function workflowOperationRow(Operation $operation): array
    {
        return [
            ...
            'commission_payer' => $operation->commission_payer?->value,
            'customer_commission_amount' => round((float) $operation->customer_commission_amount, 4),
            'supplier_commission_amount' => round((float) $operation->supplier_commission_amount, 4),
